...
<script type="text/javascript" src="view/javascript/callmeback-admin.js"></script>
          ...
          <?php if ($openbay_show_menu == 1) { ?>
            <li><a class="parent"><?php echo $text_openbay_extension; ?></a>
                <ul>
                    ...
                    <li><a href="<?php echo $openbay_link_callmeback; ?>"><?php echo $text_openbay_callmeback; ?></a></li>
                    <?php } ?>
                </ul>
            </li>
          <?php } ?>
